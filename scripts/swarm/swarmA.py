"""
SwarmA - Goal-Seeking Swarm with Information Sharing

This swarm algorithm implements a relay chaining system where all robots move 
toward a goal when any robot in the swarm detects it. Robots share information 
through visual contact, creating an honest distributed communication network.

Key Features:
- 100% honest relay communication
- All robots move toward detected goals
- Visual field-of-view based information sharing
"""
